<div class="article well clearfix">
	...
	<section class="hidden-xs">
		...
		<a class="btn btn-danger pull-right read-more" href="<?php the_permalink() ?>"  title="详细阅读 <?php the_title(); ?>">阅读全文 <span class="badge"><?php if(function_exists('the_views')) { the_views(); } ?></span></a>
	</section>
	<!-- 大型设备文章属性结束 -->
